    ...
    fetch('http://localhost/ecommerce/API1/user/userread.php')
      ...
      .then(data => {
        data.forEach(event => {
          ...
          <div class="product-cell" ">
          <span class="cell-label">Action:</span><button class="app-content-headerButton"><a style = "text-decoration: none;color:white" href="update-even.html?id=${event.id}">Edit</a></button>
